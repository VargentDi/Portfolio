        ...
        <Row className="mt-5">
          ...
          <Col md="6">
            <div className={`${createFadeInClass()}`}>
              <p>My name is Di Zhao and I am an experienced software engineer and freelance developer. </p>
              <p>
                I have a Bachelor's degree in Physics ,minor in CS and several years of experience working
                on a wide range of technologies and projects from Node.js,Java Spring Boot and Lua development for garage and smart home devices to
